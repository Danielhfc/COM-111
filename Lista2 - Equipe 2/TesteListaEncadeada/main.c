...
Luiz Gustavo Piazza Hon�rio - 2019016303
M�rcio Gon�alves Pereira Filho  -  2019010355
*/
...
int main()
{
    ...
    //Declara��o das variaves tipo lista.
    TipoLista *le = LCria();
    TipoLista *le2;
    TipoLista *le3;
    TipoLista *le4;
    ...
    //Preencher a lista n�mero por n�mero
...
/*-----------------------------------------------------------------------------------------------------------------------------
    ...
    //Cria uma lista2 id�ntica � lista 1
    le2 = LDuplica(le);
    ...
    //O usu�rio fornecer� os valores do vetor para criar a lista3
    ...
    //O usu�rio escolhe um valor para criar a lista4 a partir do pr�ximo elemento da lista1
